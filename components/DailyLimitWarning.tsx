...
export const DailyLimitWarning: React.FC<DailyLimitWarningProps> = ({ totalHours, onClose }) => {
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-lg flex items-center justify-center p-4 animate-fade-in">
      <div className="w-full max-w-md glass-strong border-amber-900/50 shadow-glass-lg animate-scale-in">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3 text-sm text-zinc-400 leading-relaxed">
            <p className="flex items-start gap-2">
              <Coffee className="text-amber-500 flex-shrink-0 mt-1" size={16} />
              <span>
